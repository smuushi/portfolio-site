            ...
            <li data-aos="fade-right" data-aos-duration="1200">
              <div className="list_inner">
                ...
                <div className="details">
                  <div className="extra">
                    <p className="date">
                      <a href="https://www.linkedin.com/posts/michael-shih-smuushi_the-story-of-typescript-activity-7056826168766803968-H4Hu?utm_source=share&utm_medium=member_desktop">Story of TypeScript</a>
            ...
            >
              <div className="list_inner">
                ...
                <div className="details">
                  <div className="extra">
                    <p className="date">
                      <a href="https://www.linkedin.com/posts/michael-shih-smuushi_making-tanstack-table-1000x-faster-with-a-activity-7057764360982523905-MoIK?utm_source=share&utm_medium=member_desktop">Understanding One Level Deeper</a>
            ...
            >
              <div className="list_inner">
                ...
                <div className="details">
                  <div className="extra">
                    <p className="date">
                      <a href="https://www.linkedin.com/posts/michael-shih-smuushi_premature-optimization-activity-7059331965912543232-u2yM?utm_source=share&utm_medium=member_desktop">Premature Optimizations</a>
              ...
              <div className="list_inner">
                <div className="image" >
                  ...
                  <div
                    className="main"
                    style={{
                      backgroundImage: "url(assets/img/news/nomoat.jpeg)",
                    }}
                    ></div>
                  </a>
                </div>
                ...
                <div className="details">
                  <div className="extra">
                    <p className="date">
                      <a href="https://www.linkedin.com/posts/michael-shih-smuushi_google-we-have-no-moat-and-neither-does-activity-7062116822904369152-I4Kk?utm_source=share&utm_medium=member_desktop">We Have No Moat</a>
                  ...
                  <div className="tokyo_tm_read_more">
                    <a href="https://www.linkedin.com/posts/michael-shih-smuushi_google-we-have-no-moat-and-neither-does-activity-7062116822904369152-I4Kk?utm_source=share&utm_medium=member_desktop">
                      <span>Read More</span>
                    </a>
                  </div>
                </div>
